...
public class ClasseAlunoExecutavel {
	...
	public static void main(String[] args) {
		...
		try {
			...
			if (new FuncaoAutenticacao(new Diretor(login, senha)).autenticar()) {// Vou travar o contrato para autorizar
				...
				/*
				 * Objeto ainda não existe na memória Aluno aluno1;
				 * 
				 * Agora temos um objetoo real na memoria Aluno aluno2 = new Aluno();
				 */
				/* new Aluno() é uma instancia (Criação de Obejto) */
				/* aluno1 é uma referência para o objeto aluno */
				// Aluno aluno1 = null; Quando esquece de instanciar um dos motivos, mais podem
				// ser vários. Aprendemos identificar.

				/*
				 * É uma lista que dentro dela temos uma chave que identifiva uma sequencia de
				 * valores também
				 */
				...
				for (int qtd = 1; qtd <= 1; qtd++) {
					 ...
					 * String rg= JOptionPane.showInputDialog("Numero RG"); String cpf=
					 ...
					 * JOptionPane.showInputDialog("Data da matrícula?"); String escola=
					 ...
					 * aluno1.setNomePai(nomePai); aluno1.setDataMatricula(matricula);
					 * aluno1.setNomeEscola(escola); aluno1.setSerieMatricula(serie);
					 */
					 ...
					 * disciplina1.setDisciplina("Português"); disciplina1.setNota(90);
					 * 
					 * aluno1.getDisciplinas().add(disciplina1);
					 * 
					 * Disciplina disciplina2 = new Disciplina();
					 * disciplina2.setDisciplina("Matemática"); disciplina2.setNota(95);
					 * 
					 * aluno1.getDisciplinas().add(disciplina2);
					 * 
					 * Disciplina disciplina3 = new Disciplina();
					 * disciplina3.setDisciplina("História"); disciplina3.setNota(70);
					 * 
					 * aluno1.getDisciplinas().add(disciplina3);
					 * 
					 * Disciplina disciplina4 = new Disciplina();
					 * disciplina4.setDisciplina("Geografia"); disciplina4.setNota(84);
					 * 
					 * aluno1.getDisciplinas().add(disciplina4);
					 * 
					 * Disciplina disciplina5 = new Disciplina();
					 * disciplina5.setDisciplina("Artes"); disciplina5.setNota(100);
					 * 
					 ...
					 * System.out.println("Resultado: " + (aluno1.getAlunoAprovado1() ? "Aprovado" :
					...
					// System.out.println("Resultado: " + (aluno1.getAlunoAprovado1() ? "Aprovado "
					// : "Reprovado ") + "Aluno " + aluno1.getNome());

					// Equals e hashcode(Diferenciar e comparar objetos)
					/*
					 * Aluno aluno1 = new Aluno(); aluno1.setNome("Pierre");
					 * aluno1.setNumeroCpf("253");
					 * 
					 * Aluno aluno2 = new Aluno(); aluno2.setNome("Pierre");
					...
					/*
					 * aluno = new Aluno(); System.out.println(aluno);
					 * 
					 * aluno = new Aluno(); System.out.println(aluno.toString());
					 */
				 ...
				 */
				/*
				 * if (aluno.getNome().equalsIgnoreCase("Pierre")) { alunos.remove(aluno);
				 * break; }else { System.out.println(aluno.toString());//Descrição do objeto na
				 * memoria System.out.println("Média da nota final: " + aluno.getMediaNota());
				 * System.out.println("Resultado: " + aluno.getAlunoAprovado2());
				 * System.out.println();
				 * System.out.println("=================================================");
				 * //System.out.println(); }
				 ...
				 * System.out.println("================================================="); }
				 * 
				 * System.out.println("As notas por disciplinas são:"); for (Disciplina
				 * notaDisciplina : aluno.getDisciplinas()) {
			 ...
			 * "Opaa um null pointer exception: " + e.getClass()); }catch
			 * (FileNotFoundException e) {//Captura todas as exceções que não prevemos
			 * e.printStackTrace(); JOptionPane.showMessageDialog(null,
			 * "Erro da exceção customizada: " + e.getClass().getName());
			 * //System.out.println("Memsagem: " + e.getMessage()); ///
			 */
		} finally {/*
					 * Sempre é executado ocorrendo erros ou não FInally sempre é usado quando
					 * precisa executar um processo acontecendo erro ou nãp no sistema
					 */
	...
	/* ======================================================================= */
	/*
	 * aluno1.nome = "Bernardo"; aluno1.idade = 8;
	 * 
	 * System.out.println("Nome do 1º Aluno: " + aluno1.nome);
	 * System.out.println("Idade do " + aluno1.nome + ": " + aluno1.idade +
	 * " anos");
	 */
	/*
	 * Aluno aluno2 = new Aluno();//Aluno Pierre
	 * 
	 * aluno2.setNome("Pierre"); aluno2.setIdade(48);
	 * aluno2.setDataNascimento("02/01/1978");
	 * aluno2.setRegistroGeral("35.632.105-8");
	 * aluno2.setNumeroCpf("005.966.859-80"); aluno2.setNomeMae("Sandra");
	 * aluno2.setNomePai("Pierre"); aluno2.setDataMatricula("06/06/2023");
	 * aluno2.setNomeEscola("Faculdade Facint");
	 * aluno2.setSerieMatricula("Curso ADS"); aluno2.setNota01(55);
	 * aluno2.setNota02(98.9); aluno2.setNota03(73.5); aluno2.setNota03(87.7);
	 * 
	 ...
	 * System.out.println("Resultado: " + (aluno2.getAlunoAprovado1() ? "Aprovado" :
	 * "Reprovado")); System.out.println("Resultado: " +
